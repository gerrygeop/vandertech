<div class="flex flex-col w-64 h-full px-4 py-4 bg-white border-r">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            ...
            <x-sidenav-link :href="route('news.index')" :active="request()->routeIs('news.*')">
            ...
            <x-sidenav-link href="#">
                <x-icon d="M15 5V7M15 11V13M15 17V19M5 5C3.89543 5 3 5.89543 3 7V10C4.10457 10 5 10.8954 5 12C5 13.1046 4.10457 14 3 14V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V14C19.8954 14 19 13.1046 19 12C19 10.8954 19.8954 10 21 10V7C21 5.89543 20.1046 5 19 5H5Z" />
