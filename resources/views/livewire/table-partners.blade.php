<div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-4 lg:grid-cols-8 gap-y-4 items-center mb-6 px-2 md:px-0">
        <div class="col-span-full lg:col-span-4 flex justify-end lg:justify-start">
        ...
        <div class="col-span-full lg:col-span-4 flex justify-end">
            <select name="kategori" wire:model="kategori" class="w-full md:w-auto select-menu">
        ...
        <div class="col-span-full flex rounded-md">
            <span
        ...
        <tbody class="bg-white divide-y divide-slate-200">
            ...
            @forelse ($partners as $partner)
                <tr wire:loading.remove>
                    ...
                    <td class="p-4 whitespace-nowrap">
                        <div class="text-xs lg:text-sm font-normal text-slate-700">
                            {{ $partner->name }}
                        </div>
                    </td>
                    <td class="p-4 whitespace-nowrap">
