...
<div class="relative  overflow-hidden mt-24">
    <div class="max-w-7xl mx-auto">
        <div class="relative z-20 pb-8 bg-white sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32 lg:max-w-2xl lg:w-full">
            <svg 
                class="hidden lg:block z-10 absolute right-0 inset-y-0 h-full w-32 text-white transform translate-x-1/2" 
                fill="currentColor" 
                viewBox="0 0 100 100" 
