<footer class="text-slate-600 bg-white border-t">
    <div class="max-w-6xl px-2 sm:px-5 py-5 mx-auto flex items-center">
        ...
        <a class="flex items-center justify-center md:justify-start">
            ...
            <span class="ml-2 text-base md:text-lg text-slate-600 md:font-semibold tracking-wide">Wana</span>
        </a>

        <p class="text-xs sm:text-sm text-slate-500 ml-3 sm:ml-4 pl-3 sm:pl-4 border-l-2 border-slate-200 sm:py-2">
