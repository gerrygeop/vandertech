<div class="min-h-screen px-6 py-16 mx-auto text-center flex justify-center items-center">
    <div class="max-w-lg mx-auto">
        ...
        <div class="w-full max-w-sm mx-auto mt-6 bg-transparent rounded-md">
            <a class="block lg:hidden h-10 px-4 py-2 m-1 text-white transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400"
            href="#">
            Contact Us
        </a>
        </div>
