<a href="{{ $link }}">
    <div class="group relative overflow-hidden bg-transparent transition-all duration-200">
        ...
        <div class="pb-4 bg-blue-600/70 backdrop-blur-sm absolute border -bottom-10 inset-x-0 h-0 group-hover:bottom-0 group-hover:h-full lg:py-2 transition-all duration-200">
